...
#define __( c )                     \
	...
	_UNTIL( ' ' ) _GET_NUMBER( ret_code ) for( ;; )
	{
		...
		case 'C':
			...
			_( 't' )
			_( '-' )
			_( 'L' ) _( 'e' ) _( 'n' ) _( 'g' ) _( 't' ) _( 'h' ) _( ':' ) _( ' ' ) _GET_NUMBER( content_length ) break;
		case 'T':
			_( 'r' )
			_( 'a' )
			_( 'n' )
			...
			_( '-' )
			_( 'E' )
			_( 'n' ) _( 'c' ) _( 'o' ) _( 'd' ) _( 'i' ) _( 'n' ) _( 'g' ) _( ':' ) _( ' ' ) _( 'c' ) _( 'h' ) _( 'u' )
...
void influxdb_cpp::detail::inner::url_encode( std::string& out, const std::string& src )
{
